...
fn make_box_tab(dbox: &DBox, window: &ApplicationWindow, tab_num: u32) -> gtk::Box {
    ...
    // a stopped box starts it - so the terminal, upgrade, applications and
    // package-install rows all bring it up - and distrobox cannot clone a
