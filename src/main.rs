...
use adw::{
    prelude::{
        ActionRowExt, ComboRowExt, EntryRowExt, MessageDialogExt, PreferencesGroupExt,
        PreferencesRowExt,
    },
...
use distrobox_handler::{
    ...
    open_terminal_in_box, remove_app_from_host, remove_exported_binary_from_box,
    run_command_in_box, stop_box, upgrade_all_boxes, upgrade_box, DBox, DBoxApp,
};

mod utils;
use utils::{
    detect_pkg_manager, get_assemble_icon, get_available_app_icon_name, get_available_icon_name,
    get_box_home, get_cpu_and_mem_usage, get_deb_distros, get_distro_img, get_download_dir_path,
    get_host_home_dir, get_my_deb_boxes, get_my_rpm_boxes, get_profiles, get_rpm_distros,
    ...
    image_publisher, open_path_in_file_manager, profile_label_for_home, remove_profile,
    ...
    INSTALL_PACKAGE_ICON_NAMES, MENU_ICON_NAMES, REMOVE_ICON_NAMES, STOP_ICON_NAMES,
...
fn get_main_menu_model() -> gio::MenuModel {
    ...
    menu.insert_item(
        ...
        &gio::MenuItem::new(
            //TRANSLATORS: Menu Item
            Some(&gettext("Profiles")),
            Some("win.show_profiles"),
        ),
    );
    menu.insert_item(
        3,
